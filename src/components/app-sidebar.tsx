...
import { LayoutDashboard, Mail, FileText, CalendarCheck, Search, MessagesSquare, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const items = [
  ...
  { title: "Task Planner", url: "/task-planner", icon: CalendarCheck },
